...
#include "Factories/FluidRenderingMaterialFactory.h" // CATACLYSM
#include "Fluid/FluidRenderingMaterial.h" // CATACLYSM
...
// CATACLYSM Begin
/*-----------------------------------------------------------------------------
UFluidRenderingMaterialFactory.
-----------------------------------------------------------------------------*/
UFluidRenderingMaterialFactory::UFluidRenderingMaterialFactory(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	SupportedClass = UFluidRenderingMaterial::StaticClass();

	bCreateNew = true;
	bEditAfterNew = true;
}

UObject* UFluidRenderingMaterialFactory::FactoryCreateNew(UClass* InClass, UObject* InParent, FName InName, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
	UFluidRenderingMaterial* FluidRenderingMaterial = NewObject<UFluidRenderingMaterial>(InParent, InName, Flags);
