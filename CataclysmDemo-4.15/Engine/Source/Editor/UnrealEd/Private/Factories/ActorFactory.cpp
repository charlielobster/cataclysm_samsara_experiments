...
#include "ActorFactories/ActorFactoryFLIPSolverDomain.h" // CATACLYSM
#include "ActorFactories/ActorFactoryFluidVelocityField.h" // CATACLYSM
...
// CATACLYSM Begin
/*-----------------------------------------------------------------------------
UActorFactoryFLIPSolverDomain
-----------------------------------------------------------------------------*/
UActorFactoryFLIPSolverDomain::UActorFactoryFLIPSolverDomain( const FObjectInitializer& ObjectInitializer )
	: Super(ObjectInitializer)
{
	DisplayName = LOCTEXT("FLIPSolverDomainDisplayName", "FLIP Solver Domain");
	NewActorClass = AFLIPSolverDomain::StaticClass();
}

/*-----------------------------------------------------------------------------
UActorFactoryFluidVelocityField
-----------------------------------------------------------------------------*/
UActorFactoryFluidVelocityField::UActorFactoryFluidVelocityField(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	DisplayName = LOCTEXT("FluidVelocityFieldDisplayName", "Fluid Velocity And Kill Field");
	NewActorClass = AFluidVelocityField::StaticClass();
}
// CATACLYSM End
