...
public:
	...
	virtual void StartupModule() override
	{
...

		{
			...
			// CATACLYSM Begin
			Category->Items.Add(CreateID(), MakeShareable( new FPlaceableItem(*UActorFactoryFluidVelocityField::StaticClass(), SortOrder+=10)) );
			// CATACLYSM End
		}
...

		{
			...
			// CATACLYSM Begin
			Category->Items.Add(CreateID(), MakeShareable( new FPlaceableItem(*UActorFactoryFLIPSolverDomain::StaticClass(), SortOrder+=10)) );
			// CATACLYSM End
		}
