	...
	// NVCHANGE_END: Add HBAO+
{
	...
	check(FeatureLevel == D3D_FEATURE_LEVEL_11_1 || FeatureLevel == D3D_FEATURE_LEVEL_11_0 || FeatureLevel == D3D_FEATURE_LEVEL_10_0 ); // CATACLYSM Extend RHI for VTR
	...
	else if(FeatureLevel == D3D_FEATURE_LEVEL_11_1 || FeatureLevel == D3D_FEATURE_LEVEL_11_0) // CATACLYSM Extend RHI for VTR
	{
