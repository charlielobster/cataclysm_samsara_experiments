...
FPixelShaderRHIRef FMetalDynamicRHI::RHICreatePixelShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM
{
...
FComputeShaderRHIRef FMetalDynamicRHI::RHICreateComputeShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM
{ 
