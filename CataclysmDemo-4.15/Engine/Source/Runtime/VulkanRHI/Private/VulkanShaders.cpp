...
FPixelShaderRHIRef FVulkanDynamicRHI::RHICreatePixelShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM more atomic float ops in shaders
{
...
FComputeShaderRHIRef FVulkanDynamicRHI::RHICreateComputeShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM more atomic float ops in shaders
{ 
