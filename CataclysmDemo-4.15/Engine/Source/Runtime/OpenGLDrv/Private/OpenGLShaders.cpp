...
FPixelShaderRHIRef FOpenGLDynamicRHI::RHICreatePixelShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM more atomic float ops in shaders
{
...
FComputeShaderRHIRef FOpenGLDynamicRHI::RHICreateComputeShader(const TArray<uint8>& Code, int NvShaderExtnSlot) // CATACLYSM more atomic float ops in shaders
{
	check(GMaxRHIFeatureLevel >= ERHIFeatureLevel::SM5);
