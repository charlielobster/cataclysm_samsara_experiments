...
public:
	...
	virtual FPixelShaderRHIRef RHICreatePixelShader(const TArray<uint8>& Code, int NvShaderExtnSlot) final override; // CATACLYSM
	...
	virtual FComputeShaderRHIRef RHICreateComputeShader(const TArray<uint8>& Code, int NvShaderExtnSlot) final override; // CATACLYSM
	...
	virtual void RHISetRenderTargets(uint32 NumSimultaneousRenderTargets, const FRHIRenderTargetView* NewRenderTargets, const FRHIDepthRenderTargetView* NewDepthStencilTarget, uint32 NumUAVs, const FUnorderedAccessViewRHIParamRef* UAVs, int initUAVCount = -1) final override; // CATACLYSM
