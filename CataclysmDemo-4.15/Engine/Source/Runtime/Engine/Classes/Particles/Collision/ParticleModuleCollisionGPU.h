...
class UParticleModuleCollisionGPU : public UParticleModuleCollisionBase
{
	...
	// BEGIN CATACLYSM
	UPROPERTY(EditAnywhere, Category=Cataclysm)
	TEnumAsByte<ELiquidParticleType::Type> LiquidType;

	// This emitter should spawn particles for Collision events.
	UPROPERTY(EditAnywhere, Category=Cataclysm)
	uint32 bCollisionSprayEvent: 1;
	
	// This emitter should spawn particles for Escape events.
	UPROPERTY(EditAnywhere, Category=Cataclysm)
	uint32 bEscapeSprayEvent: 1;
	
	// This emitter should spawn particles for Splash events.
	UPROPERTY(EditAnywhere, Category=Cataclysm)
	uint32 bSplashSprayEvent: 1;

	UPROPERTY(EditAnywhere, Category=Cataclysm, meta = (ClampMin = "0", ClampMax = "1"))
