...
public:
	...
	*/
	...
	// BEGIN CATACLYSM
	/**
	 *	Set the spray spawn percentage.
	 *
	 *	@param	EmitterIndex		The index of the emitter to set it on
	 *	@param	NewPercentage		The value to set it to
	 */
	UFUNCTION(BlueprintCallable, Category="Effects|Fluid|Spray")
	void SetSpraySpawnPercentage(int32 EmitterIndex, float NewPercentage);
	// END CATACLYSM
...
public:
	 ...
	 *	Updates the parameter if it already exists, or creates a new entry if not. 
	 */
	UFUNCTION(BlueprintCallable, Category="Effects|Components|ParticleSystem") // CATACLYSM
