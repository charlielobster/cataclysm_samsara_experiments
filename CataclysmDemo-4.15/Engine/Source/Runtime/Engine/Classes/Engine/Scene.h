...
struct FPostProcessSettings
{
	...
	UPROPERTY(BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault))
	uint32 bOverride_HBAONearAO : 1;

	UPROPERTY(BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault))
	uint32 bOverride_HBAOFarAO : 1;

	UPROPERTY(BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault))
	uint32 bOverride_HBAOForegroundViewDepth : 1;

	UPROPERTY(BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault))
	uint32 bOverride_HBAOBackgroundViewDepth : 1;
	...
	UPROPERTY(interp, BlueprintReadWrite, Category = "HBAO+", meta = (editcondition = "bOverride_HBAOEnable", DisplayName = "Enable"))
	uint32 HBAOEnable:1;
	...
	UPROPERTY(interp, BlueprintReadWrite, Category = "HBAO+", meta = (ClampMin = "0.0", UIMax = "1.0", editcondition = "bOverride_HBAONearAO", DisplayName = "Near AO"))
	float HBAONearAO;

	/** 0..1 strength of the low-range occlusion .. set to 0.0 to improve performance */
	UPROPERTY(interp, BlueprintReadWrite, Category = "HBAO+", meta = (ClampMin = "0.0", UIMax = "1.0", editcondition = "bOverride_HBAOFarAO", DisplayName = "Far AO"))
	float HBAOFarAO;

	/** 0..1 strength of the low-range occlusion .. set to 0.0 to improve performance */
	UPROPERTY(interp, BlueprintReadWrite, Category = "HBAO+", meta = (ClampMin = "0.0", UIMax = "1.0", editcondition = "bOverride_HBAOForegroundViewDepth", DisplayName = "Foreground view depth"))
	float HBAOForegroundViewDepth;

	/** 0..1 strength of the low-range occlusion .. set to 0.0 to improve performance */
	UPROPERTY(interp, BlueprintReadWrite, Category = "HBAO+", meta = (ClampMin = "0.0", UIMax = "1.0", editcondition = "bOverride_HBAOBackgroundViewDepth", DisplayName = "Background view depth"))
	float HBAOBackgroundViewDepth;
	...
	*/
	...
	FPostProcessSettings()
	{
		...
		HBAONearAO = 1.f;
		HBAOFarAO = 1.f;
		HBAOForegroundViewDepth = -1.0f;
		HBAOBackgroundViewDepth = -1.0f;
		HBAOBlurRadius = AOBR_BlurRadius4;
		HBAOBlurSharpness = 4.f;
		// NVCHANGE_END: Add HBAO+
