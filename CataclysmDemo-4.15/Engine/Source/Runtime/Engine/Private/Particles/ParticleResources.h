...
public:
	...
	FParticleBufferParamRef GetSprayBufferParam();
	FParticleShaderParamRef GetSprayShaderParam();
	FUnorderedAccessViewRHIParamRef GetSprayUAVParam();
	// END CATACLYSM Spray
...
private:
	...
	// BEGIN CATACLYSM Spray
	FVertexBufferRHIRef SprayVertexBufferRHI;
	FShaderResourceViewRHIRef SprayVertexBufferSRV;
	FUnorderedAccessViewRHIRef SprayVertexBufferUAV;
	// END CATACLYSM Spray
};
