...
class FResolveDepthDownsampleNonMSPS : public FGlobalShader
{
	DECLARE_EXPORTED_SHADER_TYPE(FResolveDepthDownsampleNonMSPS, Global, UTILITYSHADERS_API);
public:
	...
	FResolveDepthDownsampleNonMSPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer) :
		FGlobalShader(Initializer)
	{
		UnresolvedSurface.Bind(Initializer.ParameterMap, TEXT("UnresolvedSurfaceNonMS"), SPF_Mandatory);
	}
	FResolveDepthDownsampleNonMSPS() {}
...
class FResolveDownsampleNonMSPS : public FGlobalShader
{
	DECLARE_EXPORTED_SHADER_TYPE(FResolveDownsampleNonMSPS, Global, UTILITYSHADERS_API);
public:
	...
	FResolveDownsampleNonMSPS(const ShaderMetaType::CompiledShaderInitializerType& Initializer) :
		FGlobalShader(Initializer)
	{
		UnresolvedSurface.Bind(Initializer.ParameterMap, TEXT("UnresolvedSurfaceToDownsample"), SPF_Mandatory);
	}
	FResolveDownsampleNonMSPS() {}
