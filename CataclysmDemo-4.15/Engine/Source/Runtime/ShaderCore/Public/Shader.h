...
public:
	...
	/** Fake UAV slot for NV HLSL backdoor, copied from FShader::GetNvShaderExtnSlot in places where FShaderResource is constructed */
	int32 NvShaderExtnSlot;
...
*/
	...
	// CATACLYSM Begin more atomic float ops in shaders
	virtual int GetNvShaderExtnSlot()
	{
		return -1;
	}
	// CATACLYSM En more atomic float ops in shaders
