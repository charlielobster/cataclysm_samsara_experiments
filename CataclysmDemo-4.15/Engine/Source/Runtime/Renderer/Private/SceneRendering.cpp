	...
	FViewUniformShaderParameters& ViewUniformShaderParameters) const
{
	...
	// CATACLYSM NVCHANGE_BEGIN: Improve super-sampling
	ViewUniformShaderParameters.ScreenPercentageFactor = uint32(FinalPostProcessSettings.ScreenPercentage / 100.f);
	// CATACLYSM NVCHANGE_END: Improve super-sampling
